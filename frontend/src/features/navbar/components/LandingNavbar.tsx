  ...
  return (
    <div className="w-full bg-white/70 sticky top-0 z-30 backdrop-blur-md">
              ...
              <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                ...
                <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-2">
                  <div className="flex w-full items-center justify-start my-3">
                    ...
                    />
                    <div>
                      <h1 className="font-bold text-lg">Jouvire</h1>
                  ...
                  <nav className="flex flex-1 flex-col gap-y-4">
                    <ul className="-mx-2 space-y-1">
                      <li className="">
                        <Link
                          href="/dashboard"
                          className="group flex gap-x-3 rounded-md p-2 text-sm leading-6 justify-start hover:bg-gray-100"
                        >
                          <LogIn
      ...
      <nav className="flex w-full h-16 ">
        <div className="w-full flex flex-row mx-auto max-w-7xl py-4 px-2 sm:px-6 lg:px-8 items-center justify-between">
          <div>
            <Link href="/">
              <div className="flex flex-row items-center justify-center gap-x-2">
                ...
                />
                <h1 className="font-bold text-xl">Jouvire</h1>
              </div>
            </Link>
          </div>
            ...
            <Link href="/">
              <div className="flex flex-row items-center justify-center gap-x-2">
                <Image
                  ...
                  className="text-lunaPink"
                />
                <h1 className="font-bold text-xl">Luna</h1>
              </div>
            </Link>
          </div>
        </div>
