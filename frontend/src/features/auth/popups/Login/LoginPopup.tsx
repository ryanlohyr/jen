...
import { signIn, signInWithGoogle } from "../../components/authService";
...
const LoginPopup = ({
  ...
  async function onSubmit(values: z.infer<typeof emailPasswordSchema>) {
    const userResponse = await signIn(values);
      ...
      <DialogContent className="sm:max-w-[425px]">
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <h1 className="text-3xl font-sans mx-auto">Log in</h1>
